                                            ...
                                            @foreach ($latedProducts as $pr)
                                                <a href="#" class="latest-product__item">
                                                    <div class="latest-product__item__pic">
                                                        <img src="@foreach ($pr->rImages as $image)./images/{{ $image->name }}@break @endforeach"
                                                            alt="">
                                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="product__discount__item">
                                                <div class="product__discount__item__pic set-bg"
                                                    data-setbg="@foreach ($product->rImages as $image)./images/{{ $image->name }}@break @endforeach">
                                                    ...
                                                    <ul class="product__item__pic__hover">
                                                        ...
                                                        <li>
                                                            <a onclick="onAdding2Cart({{ $product->id }})">
